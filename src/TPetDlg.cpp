...
void TPetDlg::accept()
  ...
  if (markingDateEdit->date()<birthdateEdit->date())
    {
    QMessageBox::critical(this,tr("Error"),tr("The marking date can't be earlier than the birth date."),QMessageBox::Ok);
    markingDateEdit->setFocus();
    return;
    }
